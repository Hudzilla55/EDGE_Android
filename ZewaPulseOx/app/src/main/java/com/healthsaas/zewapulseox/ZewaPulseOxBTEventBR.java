...
public class ZewaPulseOxBTEventBR extends BroadcastReceiver {
    private static final String TAG = ZewaPulseOxBTEventBR.class.getSimpleName();
        ...
        switch(action)
        {
            case BluetoothAdapter.ACTION_STATE_CHANGED:
                ...
                if (state == BluetoothAdapter.STATE_OFF)
                {
                    ...
                    ZewaPulseOxExceptionHandler.exitApp(0);
                }
