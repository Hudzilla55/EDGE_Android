...
public class Constants {
     ...
     *  NFC card constants
     */
    static final String COM_HEALTHSAAS_ZEWAPULSEOX = "com.healthsaas.zewapulseox";

    // make sure doesn't clash with com.healthsaas.zewapulseox.Constants.
...
//    public static final int CMD_PATIENT_ID = 55;
    ...
    static final String MGR_NAME = "PulseOx Manager";
    ...
    public static final String ZEWA_MODEL_PULSEOX = "Zewa PulseOx";

    static final int TMO_PULSEOX_SEARCH = 30 * 1000;
    static final int TMO_PULSEOX_NEW_DATA_SEARCH = 12 * 1000;
    static final int TMO_PULSEOX_NEW_DATA_SEARCH_PAUSE = 12 * 1000;
    static final int TMO_PULSEOX_SYNC = 2 * 60 * 1000;

    static final int STATE_TRANSITION_TIME = 200;

    public static final String PULSEOX_DATA_TYPE = "PO";
    public static final String PULSEOX_PREFS_NAME = "pulseox_prefs";
    public static final String PULSEOX_ROOT_URL_DEFAULT = "https://demo.ourconnectedhealth.com/ws/austonio/";
    public static final String PREFS_NAME = "pulseox_prefs";
