...
@TargetApi(23)
public class ZewaPulseOxBootCompleteBR extends BroadcastReceiver {
    private static final String TAG = ZewaPulseOxBootCompleteBR.class.getSimpleName();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_BOOT_COMPLETED.equalsIgnoreCase(action)) {
            ...
            PulseOxSettings.checkForNewSettings();
