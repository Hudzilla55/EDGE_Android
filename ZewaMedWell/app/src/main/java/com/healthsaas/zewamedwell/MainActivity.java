...
import static com.healthsaas.zewamedwell.zewa.medwell.MedWellSettings.checkForNewSettings;
...
public class MainActivity extends Activity {
    ...
    public static final String RECEIVE_MSG = "com.healthsaas.zewamedwell.RECEIVE_MSG";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getIMEI();
        Log.i(TAG, "Main Activity Launched. RootUrl: " + MedWellSettings.getRootURL());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings_scan) {
            ...
            ZewaMedWellExceptionHandler.recycleApp(-5);
            return true;
        }
    ...
    private void sendZewaManagerIntent(int command, String btMac) {
        ...
        bundle.putInt(ZewaMedWellManager.KEY_CMD_ID, command);
        bundle.putString(ZewaMedWellManager.KEY_MODEL_NAME, Constants.ZEWA_MODEL_MEDWELL);
        bundle.putString(ZewaMedWellManager.KEY_BT_MAC, btMac);

        Intent intent = new Intent(ZewaMedWellApp.getAppContext(), ZewaMedWellManager.class);
        intent.setAction(ZewaMedWellManager.ACTION_NFC_EVENT)
                .putExtras(bundle);

        ZewaMedWellApp.getAppContext().startService(intent);
    }
    ...
    public void showRemoveDialog() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                builder.setTitle(R.string.select_medwell_to_remove)
                        ...
                        .setItems(serialNumbers, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                final String RemoveMedWellSerialNumber = serialNumbers[which].toString();
                                AlertDialog.Builder builder2 = new AlertDialog.Builder(MainActivity.this);
                                builder2.setTitle(R.string.confirm_medwell_to_remove)
                                        .setMessage("Remove this MedWell: " + RemoveMedWellSerialNumber)
                                        .setPositiveButton(R.string.button_remove, new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                // Remove this MedWell!
                                                sendZewaManagerIntent(Constants.CMD_BT_UNPAIR, RemoveMedWellSerialNumber);
                                                pairedDevices--;
                                                updateDisplay();
                                            }
                                        })
