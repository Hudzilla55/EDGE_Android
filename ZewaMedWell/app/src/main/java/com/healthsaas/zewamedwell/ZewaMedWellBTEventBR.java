...
public class ZewaMedWellBTEventBR extends BroadcastReceiver {
    private static final String TAG = ZewaMedWellBTEventBR.class.getSimpleName();
        ...
        switch(action)
        {
            case BluetoothAdapter.ACTION_STATE_CHANGED:
                ...
                if (state == BluetoothAdapter.STATE_OFF)
                {
                    ...
                    ZewaMedWellExceptionHandler.exitApp(0);
                }
