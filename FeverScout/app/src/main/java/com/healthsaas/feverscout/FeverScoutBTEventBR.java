...
public class FeverScoutBTEventBR extends BroadcastReceiver {
    private static final String TAG = FeverScoutBTEventBR.class.getSimpleName();
        ...
        switch(action)
        {
            case BluetoothAdapter.ACTION_STATE_CHANGED:
                ...
                if (state == BluetoothAdapter.STATE_OFF)
                {
                    ...
                    FeverScoutExceptionHandler.exitApp(0);
                }
